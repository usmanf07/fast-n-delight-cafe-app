 ...
 * @author usman
 */
public class ChooseOrderType extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            if (request.getParameter("takeaway") != null) {
                String type = "Takeaway";
                Order.customerOrder.setCustomerOrderType(type);
                RequestDispatcher rd = request.getRequestDispatcher("PaymentMethodPage.jsp");
                rd.forward(request, response);
            } else if (request.getParameter("dinein") != null) {
                String type = "Dinein";
                    Order.customerOrder.setCustomerOrderType(type);
            ...
            } else if (request.getParameter("delivery") != null) {
