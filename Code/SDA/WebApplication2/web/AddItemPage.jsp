    ...
    <div class="container">
        <div class="mbr-section-head">
            <h3 class="mbr-section-title mbr-fonts-style align-center mb-0 display-2">
                <strong>Add Item</strong></h3>
        </div>
        <div class="row justify-content-center mt-4">
            <div class="col-lg-8 mx-auto mbr-form" data-form-type="formoid">
                 <form action="${pageContext.request.contextPath}/ItemManage" method="GET">
                    <div class="dragArea row">
                        ...
                        <div class="col-md col-sm-12 form-group mb-3" data-for="email">
                            <p>Item Price: </p>
                            <input type="number" name="price" placeholder="Price" min ="1" max="100000" class="form-control">
                        </div>
                        <div class="col-12 form-group mb-3" data-for="url">
                            <p>Image URL </p>
                            <input type="text" name="url" placeholder="Image URL"  class="form-control">
                        </div>
                        ...
                        <div class="col-12 form-group mb-3" data-for="textarea">
                            <p>Stock Amount: </p>
                            <input type="number" name="stock" placeholder="Stock"class="form-control" min="1" max="10000">
                        </div>
                         <div class="col-12 form-group mb-3" data-for="textarea">
                           <label for="available">Item Availability Status:</label>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 align-center mbr-section-btn">
                               <input class="btn btn-primary display-4" type="submit" value="Add Item" name="addnewitem">
                        </div>
                        <center>
